...
Fixed_geospatial_lat_min =   30.853819
Fixed_geospatial_lat_max =   34.98418

Fixed_geospatial_lon_max =  -114.57837
Fixed_geospatial_lon_min = -119.50363



Fixed_RadarLatitude   =   32.919
Fixed_RadarLongitude  = -117.041
...
if (len(sorted(catalog.datasets)) == 0) :
    ...
    for time_index in range(len(radarless_time_series)):
        ...
        plt.suptitle("San Diego Area Surface Obs (Radar Services Down)",
                     fontsize=20, color=Mines_Blue)
