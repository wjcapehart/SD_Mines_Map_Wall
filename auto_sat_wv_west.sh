...
echo
.  /home/wjc/.bash_profile  ; $~/wjc/miniconda3/bin/python /projects/SD_Mines_Map_Wall/SAT_WV_Images_GOES_W.py > /projects/SD_Mines_Map_Wall/__log_sat_wv_west.log 2>&1
echo
echo "Ending Script"
echo
echo "Completed: `date`"
